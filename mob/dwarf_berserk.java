...
public class dwarf_villager<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(0, 32).addBox(1.5F, -2.0F, -2.0F, 5.0F, 4.0F, 4.0F, new CubeDeformation(0.2F)), PartPose.offset(3.5F, -16.0F, 0.0F));
		...
		.texOffs(0, 32).addBox(-6.0F, -2.0F, -2.0F, 5.0F, 4.0F, 4.0F, new CubeDeformation(0.2F)), PartPose.offset(-4.0F, -16.0F, 0.0F));

		PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 16).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -18.0F, 0.0F));

		PartDefinition head_r1 = head.addOrReplaceChild("head_r1", CubeListBuilder.create().texOffs(32, 29).addBox(-1.0F, -2.0F, -0.5F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.25F, -4.5F, -0.3054F, 0.0F, 0.0F));
		...
		.texOffs(52, 2).addBox(3.0F, -5.25F, 6.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.3F))
		...
		PartDefinition eye_brow_left_r1_r1 = eye_brow_left_r1.addOrReplaceChild("eye_brow_left_r1_r1", CubeListBuilder.create().texOffs(50, 1).addBox(-1.5F, 1.75F, -0.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(4.0F, 5.25F, 7.5F, 0.1745F, 0.0F, 0.0F));

		PartDefinition eye_brow_left_r1_r2 = eye_brow_left_r1.addOrReplaceChild("eye_brow_left_r1_r2", CubeListBuilder.create().texOffs(52, 2).addBox(-0.5F, 0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.3F))
		.texOffs(50, 1).addBox(-1.0F, -7.5F, -0.5F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(3.5F, 5.25F, 8.0F, 0.1745F, 0.0F, 0.0F));

		PartDefinition eye_brow_left_r1_r3 = eye_brow_left_r1.addOrReplaceChild("eye_brow_left_r1_r3", CubeListBuilder.create().texOffs(52, 2).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(3.5F, -5.75F, 7.0F, -0.829F, 0.0F, 0.0F));

		PartDefinition eye_brow_left_r1_r4 = eye_brow_left_r1.addOrReplaceChild("eye_brow_left_r1_r4", CubeListBuilder.create().texOffs(52, 2).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(3.5F, -5.75F, 5.0F, -0.829F, 0.0F, 0.0F));

		PartDefinition eye_brow_left_r1_r5 = eye_brow_left_r1.addOrReplaceChild("eye_brow_left_r1_r5", CubeListBuilder.create().texOffs(52, 2).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(3.5F, -5.75F, 3.0F, -0.829F, 0.0F, 0.0F));

		PartDefinition eye_brow_left_r1_r6 = eye_brow_left_r1.addOrReplaceChild("eye_brow_left_r1_r6", CubeListBuilder.create().texOffs(52, 2).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(3.5F, -5.75F, 1.0F, -0.829F, 0.0F, 0.0F));
		...
		PartDefinition beard2_r1 = head.addOrReplaceChild("beard2_r1", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 2.8612F, -4.9021F, -0.3054F, 0.0F, 0.0F));
		...
		.texOffs(39, 29).addBox(-6.5F, 2.5F, -1.0F, 7.0F, 2.0F, 2.0F, new CubeDeformation(0.3F))
		.texOffs(41, 29).addBox(-5.5F, 5.0F, -1.0F, 5.0F, 2.0F, 2.0F, new CubeDeformation(0.3F))
		.texOffs(43, 29).addBox(-4.5F, 7.5F, -1.0F, 3.0F, 0.0F, 2.0F, new CubeDeformation(0.3F))
