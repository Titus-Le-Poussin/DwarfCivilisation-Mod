...
public class dwarf_villager<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition left_arm = body.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(0, 32).addBox(1.5F, -2.0F, -2.0F, 5.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(3.5F, -16.0F, 0.0F));
		...
		PartDefinition head_r1 = head.addOrReplaceChild("head_r1", CubeListBuilder.create().texOffs(32, 29).addBox(0.0F, -1.5F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, -2.25F, -4.5F, 0.0F, 0.0F, 1.5708F));
		...
		PartDefinition beard2_r1_r1 = beard2_r1.addOrReplaceChild("beard2_r1_r1", CubeListBuilder.create().texOffs(19, 45).addBox(0.0F, -4.5F, 1.0F, 1.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.75F, 2.1478F, -0.2235F, 0.2618F, 0.0F, 0.0F));

		PartDefinition beard2_r1_r2 = beard2_r1.addOrReplaceChild("beard2_r1_r2", CubeListBuilder.create().texOffs(20, 46).addBox(0.0F, -4.5F, 1.0F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(18, 45).addBox(-4.0F, -5.5F, 0.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(18, 45).addBox(2.0F, -5.5F, 0.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.25F, 2.1478F, 0.7765F, 0.2618F, 0.0F, 0.0F));

		PartDefinition beard2_r1_r3 = beard2_r1.addOrReplaceChild("beard2_r1_r3", CubeListBuilder.create().texOffs(20, 46).addBox(0.0F, -6.5F, 1.0F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(20, 46).addBox(3.0F, -6.5F, 1.0F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.75F, 4.1478F, 0.7765F, 0.2618F, 0.0F, 0.0F));

		PartDefinition beard1_r1 = head.addOrReplaceChild("beard1_r1", CubeListBuilder.create(), PartPose.offsetAndRotation(3.0F, 0.0F, -4.0F, -0.3054F, 0.0F, 0.0F));

		PartDefinition beard1_r1_r1 = beard1_r1.addOrReplaceChild("beard1_r1_r1", CubeListBuilder.create().texOffs(40, 43).addBox(-2.0F, 0.0F, -0.5F, 6.0F, 1.0F, 1.0F, new CubeDeformation(-0.001F)), PartPose.offsetAndRotation(-4.0F, -3.0F, -0.5F, 0.3054F, 0.0F, 0.0F));

		PartDefinition beard1_r1_r2 = beard1_r1.addOrReplaceChild("beard1_r1_r2", CubeListBuilder.create().texOffs(40, 43).addBox(-2.0F, 0.0F, -0.5F, 6.0F, 1.0F, 1.0F, new CubeDeformation(-0.001F)), PartPose.offsetAndRotation(-4.0F, 0.0F, -0.5F, 0.3054F, 0.0F, 0.0F));

		PartDefinition beard1_r1_r3 = beard1_r1.addOrReplaceChild("beard1_r1_r3", CubeListBuilder.create().texOffs(38, 43).addBox(-4.0F, 0.0F, -0.5F, 8.0F, 1.0F, 1.0F, new CubeDeformation(-0.001F)), PartPose.offsetAndRotation(-3.0F, -1.0F, -0.5F, 0.3054F, 0.0F, 0.0F));
