package net.TitusTheDuck.dwarfcivilisation.world.structure.structures;
...
public class SmallSchistDwarfTowerStructure extends Structure<NoFeatureConfig> {


    public SmallSchistDwarfTowerStructure() {
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return SmallSchistDwarfTowerStructure.Start::new;
    }
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator,
            ...
            JigsawManager.func_242837_a(dynamicRegistryManager,
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            .getOrDefault(new ResourceLocation(DwarfCivilisationMod.MOD_ID, "small-schist-dwarf-tower/start_pool")),
            ...
            LogManager.getLogger().log(Level.DEBUG, "Small Schist Dwarf Tower at " +
