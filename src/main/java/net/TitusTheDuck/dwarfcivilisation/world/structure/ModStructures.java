package net.TitusTheDuck.dwarfcivilisation.world.structure;
...
import net.TitusTheDuck.dwarfcivilisation.world.structure.structures.SmallSchistDwarfTowerStructure;

public class ModStructures {
    public static final DeferredRegister<Structure<?>> STRUCTURES =
            DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, DwarfCivilisationMod.MOD_ID);

    public static final RegistryObject<Structure<NoFeatureConfig>> SSDTOWER =
            STRUCTURES.register("ssdtower", SmallSchistDwarfTowerStructure::new);
    ...
    public static void setupStructures() {
        setupMapSpacingAndLand(SSDTOWER.get(),
