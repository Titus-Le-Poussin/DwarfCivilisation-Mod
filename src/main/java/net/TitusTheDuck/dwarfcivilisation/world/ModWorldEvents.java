...
import net.TitusTheDuck.dwarfcivilisation.world.gen.ModStructureGeneration;
...
public class ModWorldEvents {
    ...
    public static void addDimensionalSpacing(final WorldEvent.Load event) {
        if(event.getWorld() instanceof ServerWorld) {
            ...
            tempMap.putIfAbsent(ModStructures.SSDTOWER.get(),
                    DimensionStructuresSettings.field_236191_b_.get(ModStructures.SSDTOWER.get()));
