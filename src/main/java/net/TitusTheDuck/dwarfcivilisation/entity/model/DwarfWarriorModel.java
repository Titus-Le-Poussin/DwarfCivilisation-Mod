package net.TitusTheDuck.dwarfcivilisation.entity.model;// Made with Blockbench 4.12.6
...
public class DwarfWarriorModel<T extends Entity> extends EntityModel<T> {
	@Override
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "dwarf_villager_2"), "main");
	...
	public DwarfWarriorModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition beard5_r1 = head.addOrReplaceChild("beard5_r1", CubeListBuilder.create().texOffs(8, 51).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(-0.04F)), PartPose.offsetAndRotation(1.0F, -0.1388F, -4.9021F, -0.2986F, 0.0387F, 0.1251F));

		PartDefinition beard5_r2 = head.addOrReplaceChild("beard5_r2", CubeListBuilder.create().texOffs(0, 51).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(-0.001F)), PartPose.offsetAndRotation(-1.0F, -0.1388F, -4.9021F, -0.3052F, 0.0F, -0.165F));
		...
		PartDefinition beardgroup = head.addOrReplaceChild("beardgroup", CubeListBuilder.create(), PartPose.offsetAndRotation(3.0F, -1.2608F, -2.5969F, 0.3054F, 0.0F, 0.0F));
