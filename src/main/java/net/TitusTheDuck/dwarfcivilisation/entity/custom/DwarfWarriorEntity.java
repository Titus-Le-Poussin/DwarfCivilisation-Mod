...
public class DwarfWarriorEntity extends VillagerEntity {
    ...
    protected void registerGoals() {
        // On appelle super pour garder les comportements de base du villageois
        super.registerGoals();
        ...
        // Priorités de ciblage - attaque les monstres
    ...
    public boolean attackEntityAsMob(Entity target) {
        ...
        if (attacked && target instanceof LivingEntity) {
            // Le nain guerrier inflige des dégâts supplémentaires
    ...
    // Empêche le nain de paniquer comme un villageois normal
    @Override
