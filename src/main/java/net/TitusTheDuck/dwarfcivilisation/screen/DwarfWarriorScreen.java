...
@OnlyIn(Dist.CLIENT)
public class DwarfWarriorScreen extends ContainerScreen<DwarfWarriorContainer> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(
            DwarfCivilisationMod.MOD_ID, "textures/gui/dwarf_warrior_tile_entity.png");

    public DwarfWarriorScreen(DwarfWarriorContainer container, PlayerInventory inv, ITextComponent title) {
    ...
    protected void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int x, int y) {
        ...
        // Titre "Inventory" pour l'inventaire du joueur
