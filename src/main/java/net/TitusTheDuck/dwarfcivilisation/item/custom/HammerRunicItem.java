...
public class HammerRunicItem extends AutoSmeltPickaxeItem {
    public HammerRunicItem(IItemTier tier, int attackDamage, float attackSpeed, Properties properties) {
        ...
        if (!world.isRemote && entity instanceof PlayerEntity) {
            ...
            for (int i = -1; i <= 1; i++) {
                for (int j = -1; j <= 1; j++) {
                    ...
                    mineBlockWithAutoSmelt(world, targetState, targetPos);
    ...
    private void mineBlockWithAutoSmelt(World world, BlockState blockState, BlockPos pos) {
